...
class Head(nn.Module):
    ...
    def batchLoss(self, fpn_feat, batch_bboxes, batch_angles, batch_labels, input_shape):
        # head部分前向
        # [[bs, cls_num, w, h],...,[...]] [[bs, 1, w, h],...,[...]] [[bs, 4, w, h],...,[...]] [[bs, 1, w, h],...,[...]]
        cls_logits, cnt_logits, reg_preds, angle_preds = self.forward(fpn_feat)
        '''FCOS的正负样本分配'''
        ...
        '''loss以字典形式回传'''
        loss = dict(
            total_loss = cls_loss + cnt_loss + reg_loss + theta_loss,
            cls_loss = cls_loss,
            cnt_loss = cnt_loss,
            reg_loss = reg_loss,
